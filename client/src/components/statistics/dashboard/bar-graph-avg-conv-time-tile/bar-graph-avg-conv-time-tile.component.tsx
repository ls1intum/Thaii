...
function BarGraphAvgConvTile({ value, state, setState, title, labels }: GraphParams) {
        ...
        <Grid item xs={12}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis dataKey="object_label" />
              <YAxis />
              <Tooltip />
              <Legend />
              <Bar dataKey="avg_conv_duration" fill="#8884d8" name={labels[0]}/>
            </BarChart>
          </ResponsiveContainer>
        </Grid>
      </Grid>
...
export default BarGraphAvgConvTile;
