...
function BarGraphTile({ value, state, setState, title, labels }: GraphParams) {
        ...
        <Grid item xs={12}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="chat_count" fill="#8884d8" name={labels[0]} />
              <Bar dataKey="message_count" fill="#82ca9d" name={labels[1]} />
            </BarChart>
          </ResponsiveContainer>
        </Grid>
      </Grid>
